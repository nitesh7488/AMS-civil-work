    ...
    <ScrollReveal>
      <main className="min-h-screen bg-[#080D1A] pt-32 pb-20 selection-orange">
        ...
        <div className="container-custom relative z-10">
          ...
          {blogs.length === 0 ? (
            <div className="text-center py-20 bg-[#101827] border border-[#1E2D45] rounded-xl flex flex-col items-center justify-center animate-on-scroll">
              ...
              {blogs.map((blog, i) => {
                ...
                return (
                  <Link 
                    ...
                    href={`/blog/${blog.slug}`} 
                    className="group flex flex-col h-full bg-[#101827] border border-[#1E2D45] hover:border-orange-500/40 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.4)] hover:-translate-y-1 animate-on-scroll"
