...
export default function TopBanner() {
  return (
    <div className="bg-gradient-to-r from-orange-600 to-orange-500 text-white py-2 px-4 text-center text-sm font-medium flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 z-50 relative shadow-md">
